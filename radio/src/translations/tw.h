...
#define TR_MODULE_RANGE                EDGETX_BUTTON(TR("測距", "測距"))
#define TR_RECEIVER_OPTIONS            TR("選項", "接收機選項")
#define TR_DEL_BUTTON                  EDGETX_BUTTON(TR("刪除", "刪除"))
#define TR_RESET_BTN                   EDGETX_BUTTON("重啟")
#define TR_DEBUG                       "調試"
#define TR_KEYS_BTN                    EDGETX_BUTTON("按鍵")
#define TR_ANALOGS_BTN                 EDGETX_BUTTON(TR("類比", "類比"))
